...
def STC_CVSIM_Superimposer():
    ...
    colorbgr.place(x = 0, y = 0, width =7000, height = 2000)  
    CVType_Label  = Label(Fenster,text="Superimpose up to 50 Staircase-CVs by choosing the CV-Type number 1 to 12", bg = '#80ffbf', font = ('Arial',12,'bold'))
    CVType_Label.place(x = 25, y = 15)    
    Lab1 = Label(Fenster,text=" STCCV-Type Number", bg = '#80ffbf')
